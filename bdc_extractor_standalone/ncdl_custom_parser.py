...
class NCDLCustomExtractor:
    """Custom extractor for NCDL that uses XBRL."""
    ...
    def extract_from_url(self, filing_url: str, company_name: str, cik: str) -> Dict:
        """Extract complete NCDL investment data from XBRL."""
        ...
        out_file = os.path.join(out_dir, 'NCDL_Nuveen_Churchill_Direct_Lending_Corp_investments.csv')
...
def main():
    ...
    ex=NCDLCustomExtractor()
    try:
        res=ex.extract_from_ticker('NCDL')
