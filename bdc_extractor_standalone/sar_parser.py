...
class SARExtractor:
    ...
    def extract_from_ticker(self, ticker: str = "SAR") -> Dict:
        ...
        return self.extract_from_url(txt_url, "Saratoga_Investment_Corp", cik)
    ...
    def extract_from_url(self, filing_url: str, company_name: str, cik: str) -> Dict:
        ...
        investments: List[SARInvestment] = []
        for ctx in contexts:
        ...
        out_file = os.path.join(out_dir, 'SAR_Saratoga_Investment_Corp_investments.csv')
    ...
    def _build_investment(self, context: Dict, facts: List[Dict]) -> Optional[SARInvestment]:
...
def main():
    ...
    ex=SARExtractor()
    try:
        res=ex.extract_from_ticker('SAR')
